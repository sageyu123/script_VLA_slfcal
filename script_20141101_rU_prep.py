...
tmidstr=qa.time(qa.quantity(tmid,'s'),prec=9)[0].translate(None, ':')
timeran=t0str+'~'+t1str
f_int=2.0 #MHz
...
spwstr='spw'+slfcalms_s[0]
# timeran='16:46:19.12~16:46:19.18'
# timeran='16:46:17.825~16:46:18.025'	
calprefix='caltables/'
...
calprefix=calprefix+'cal_SUN_'+tmidstr+'T.'+spwstr
imgprefix=imgprefix+structure_id+'_'

#initial image and first slfcal table
slfcal_img_global = imgprefix+tmidstr+'T.'+spwstr+'.global.slfcal'
slfcal_img_local = imgprefix+tmidstr+'T.'+spwstr+'.local.slfcal'

slfcal_img_list = [imgprefix+tmidstr+'T.'+spwstr+'.slfcal{:d}'.format(ll) for ll in range(5)]
...
gaincal(vis=slfcalms, refant=refantenna,caltable=slfcal_table_list[slfcal_iter],spw='0:{:d}'.format(idx_selec[0]),\
